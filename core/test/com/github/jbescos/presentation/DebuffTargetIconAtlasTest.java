...
public class DebuffTargetIconAtlasTest {
    ...
    public void mapsEveryTargetDebuffToItsGeneratedCell() {
        ...
        assertEquals(11, DebuffTargetIconAtlas.indexFor(RogueliteCardId.CIPHER_SIPHON));
        ...
        assertEquals(10, DebuffTargetIconAtlas.indexFor(RogueliteCardId.FINAL_RECKONING));
    }
