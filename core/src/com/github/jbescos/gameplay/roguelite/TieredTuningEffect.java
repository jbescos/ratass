...
final class TieredTuningEffect extends RogueliteUpgradeEffect {
    ...
    private static TuningSetup setup(RogueliteCardId cardId) {
        switch (cardId) {
            ...
            case AGILE_CHASSIS:
                return tuning(0f, 0.05f, -0.07f, 0.955f);
            ...
            case CARBON_MONOCOQUE:
                return tuning(0.19f, -0.03f, 0f, 0.93f);
            case TITANIUM_DRIVE:
                return tuning(0.17f, 0f, -0.04f, 0.94f);
            ...
            case AERO_AGILE_CHASSIS:
                return tuning(0f, 0.08f, -0.05f, 0.94f);
            ...
            case TORQUE_VECTORING:
                return tuning(0.02f, 0.15f, 0f, 1f);
