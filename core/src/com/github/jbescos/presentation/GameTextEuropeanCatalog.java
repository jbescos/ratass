...
final class GameTextEuropeanCatalog {
    private static final String[][] UI_TEXT = {
        ...
        {"STRATEGY", "STRATÉGIE", "STRATEGIE", "STRATEGIA"},
        {"ALGORITHMIC", "ALGORITHMIQUE", "ALGORITHMISCH", "ALGORITMICA"},
    ...
    private static final String[][] CARD_DESCRIPTIONS = {
        ...
        {"A qualified hit marks its offender. After charging, the hook pulls them back only while they are ahead.", "Marque l'agresseur puis l'attire vers vous seulement s'il est devant.", "Markiert den Angreifer und zieht ihn nur zurück, wenn er voraus ist.", "Segna l'aggressore e lo trascina verso di te solo se è davanti."},
