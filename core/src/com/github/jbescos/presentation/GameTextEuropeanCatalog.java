...
final class GameTextEuropeanCatalog {
    ...
    private static final String[][] CARD_DESCRIPTIONS = {
        ...
        {"A quantum split creates a second physical car that races beside the original.", "Une scission quantique crée une seconde voiture physique aux côtés de l'originale.", "Eine Quantenteilung erzeugt ein zweites physisches Auto neben dem Original.", "Una scissione quantistica crea una seconda auto fisica accanto all'originale."},
        ...
        {"A quantum split creates three physical cars spread across the track.", "Une scission quantique crée trois voitures physiques sur la piste.", "Eine Quantenteilung erzeugt drei physische Autos auf der Strecke.", "Una scissione quantistica crea tre auto fisiche sulla pista."},
        {"A quantum split creates four physical cars spread across the track.", "Une scission quantique crée quatre voitures physiques sur la piste.", "Eine Quantenteilung erzeugt vier physische Autos auf der Strecke.", "Una scissione quantistica crea quattro auto fisiche sulla pista."},
        ...
        {"A rival hit marks its offender and empowers you until you strike them back.", "Un choc marque l'agresseur et vous renforce jusqu'à la riposte.", "Ein Treffer markiert den Angreifer und stärkt dich bis zum Gegenschlag.", "Un colpo segna l'aggressore e ti potenzia fino al contrattacco."},
