...
docker_args+=(
  ...
  -e RL_STAGE_CHECKPOINTS="${RL_STAGE_CHECKPOINTS:-}"
  ...
  -e RL_MAX_CHECKPOINTS="${RL_MAX_CHECKPOINTS:-6}"
  -e RL_CHECKPOINT_RADIUS="${RL_CHECKPOINT_RADIUS:-3.0}"
  ...
  -e RL_RANDOM_RACE_SPAWNS="${RL_RANDOM_RACE_SPAWNS:-1}"
  -e RL_CHECKPOINT_CURRICULUM="${RL_CHECKPOINT_CURRICULUM:-1}"
