...
docker_args+=(
  ...
  -e RL_TRAIN_BATCH_SIZE="${RL_TRAIN_BATCH_SIZE:-4096}"
  -e RL_TRAIN_LAP_BATCH_SIZE="${RL_TRAIN_LAP_BATCH_SIZE:-}"
  -e RL_LR="${RL_LR:-3e-4}"
  -e RL_GAMMA="${RL_GAMMA:-}"
  -e RL_GAE_LAMBDA="${RL_GAE_LAMBDA:-}"
  -e RL_ENTROPY_COEFF="${RL_ENTROPY_COEFF:-}"
  -e RL_CLIP_PARAM="${RL_CLIP_PARAM:-}"
  -e RL_KL_COEFF="${RL_KL_COEFF:-}"
  -e RL_KL_TARGET="${RL_KL_TARGET:-}"
  -e RL_NUM_EPOCHS="${RL_NUM_EPOCHS:-}"
  -e RL_GRAD_CLIP="${RL_GRAD_CLIP:-}"
  -e RL_VF_CLIP_PARAM="${RL_VF_CLIP_PARAM:-}"
  -e RL_VF_LOSS_COEFF="${RL_VF_LOSS_COEFF:-}"
  -e RL_SEPARATE_VALUE_NETWORK="${RL_SEPARATE_VALUE_NETWORK:-}"
  -e RL_LEARNER_REWARD_SCALE="${RL_LEARNER_REWARD_SCALE:-}"
  ...
  -e RL_ROUTE_TARGET_FRACTION="${RL_ROUTE_TARGET_FRACTION:-}"
  -e RL_ROUTE_SPAWN_RUN_ID="${RL_ROUTE_SPAWN_RUN_ID:-}"
  -e RL_ROUTE_SPAWN_SEED_DIR="${RL_ROUTE_SPAWN_SEED_DIR:-}"
  ...
  -e RL_RAY_NODE_IP="${RL_RAY_NODE_IP:-127.0.0.2}"
