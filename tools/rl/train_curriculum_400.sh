...
export RL_TRAIN_LOG="${RL_TRAIN_LOG:-logs/rl-curriculum-400.log}"
export RL_CURRICULUM_CHECKPOINT_DIR="${RL_CURRICULUM_CHECKPOINT_DIR:-rl-checkpoints-curriculum-400}"
